...
/**
* Transformation applied a rectangle. This class draws a rectangle which 
* will be transformed later on in other classes.
*
...
*/
public class TransformationOrderExample extends Frame
{
  ...
  */
  TransformationOrderExample(int height)
  {
  ...
  */
  ...
  {
    int height = 260;
    TransformationOrderExample f = new TransformationOrderExample(height);
